        ...
        >
          <ProjectBody>
            ...
            <div>
              ...
              <Description>
                <b css={css({ color: "#000000" })}>WebRTC</b> 모바일 환경에서
                얻은 페이셜 트래킹 랜드마크를 웹으로 보내주는 역할을 합니다.
                누가 WebRTC 제대로 쓰는게 어렵다고 하던데, 실시간 영상처리가
                어려운거지 기술 그 자체는 어렵지 않습니다. 막 대단한 기술이
                아니라 가장 적합해서 쓴 기술입니다.
              </Description>
              <Description>
                <b css={css({ color: "#000000" })}>Mediapipe</b> 웹에서 페이셜
                트래킹을 위한 JS기반 머신러닝 플랫폼 입니다. 구글에서 개발했고
                고2때 처음으로 알게 된 후 여러 프로젝트에서 요긴하게
                써먹었습니다.
              </Description>
              <Description>
          ...
          <ProjectBody>
            <div>
              ...
              <Description>
                ...
                최대한 가볍게 코드를 유지하면서도 개성을 살렸습니다. 누가 봐도
                made by hhj라고 인식하도록요.
              </Description>
              <Description>
                사실상 여러 프로젝트를 하면서 수 많은 컴포넌트를 개발했습니다.
                그때마다 새로 개발하는게 귀찮기도 하고 앞으로 토이 프로젝트
                하면서 디자인 시스템이 필요할텐데, 시간 절약을 위해서라도 꼭
                필요했습니다. <b>Q: 근데 새로 기존에 있는거 쓰면 안되나요?</b>{" "}
                A: 안됩니다. 누가봐도 개성이 없잖아요.
              </Description>
              <Description>
                사실 개발하는데 큰 이유를 두지는 않았고 심지어 오픈소스로
                공개되어 있어 누구나 자유롭게 사용할 수 있습니다. 추후에는
                컴포넌트 여러개를 더 추가해서 완벽한 디자인 시스템을 구성하려고
                계획중입니다.
              </Description>
            </div>
            ...
            <div>
              ...
              <Description>
                <b css={css({ color: "#000000" })}>Emotion</b> 필수 스택. 이
                외에 별다른 의존성은 없습니다.
              </Description>
            </div>
            ...
            <div>
              <Title>동작 링크</Title>
              <Button
                onClick={() => (location.href = "https://design.devent.kr/")}
              >
